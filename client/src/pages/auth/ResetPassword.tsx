...
export const ResetPassword = () => {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    console.log("Reset password submitted:", { email, otp: code, newPassword });
      ...
      <main className="relative z-10 flex min-h-[calc(100vh-96px)] items-center justify-center px-6 py-10">
        <div className="mx-auto w-full max-w-md">
          <div className="rounded-2xl border border-white/10 bg-white/3 p-8 shadow-2xl shadow-black/40 backdrop-blur-xl">
            ...
            <h2 className="mt-5 text-2xl font-semibold">Reset password</h2>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <div>
                ...
                <button
                  ...
                  className="mt-2 text-xs text-cyan-400 hover:text-cyan-300 disabled:opacity-60"
                >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-white/10 bg-black/30 py-2.5 pl-10 pr-10 text-sm text-white placeholder:text-slate-500 outline-none transition focus:border-cyan-400/60 focus:ring-1 focus:ring-cyan-400/40"
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="new-password"
                    className="w-full rounded-lg border border-white/10 bg-black/30 py-2.5 pl-10 pr-3 text-sm text-white placeholder:text-slate-500 outline-none transition focus:border-cyan-400/60 focus:ring-1 focus:ring-cyan-400/40"
                  />
                </div>
              </div>
